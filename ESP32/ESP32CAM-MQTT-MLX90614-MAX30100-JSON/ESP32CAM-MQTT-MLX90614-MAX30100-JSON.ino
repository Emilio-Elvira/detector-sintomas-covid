/*
 * Programa dek Detector de Síntomas COVID
 * por: Emilio Elvira
 * Fecha: 1 de septiembre del 2022
 * 
 * Este programa realizará la lectura de los sensores MAX30100 y MLX90614 para medir
...
//Datos de WiFi
const char* ssid = "Wireless_N_C5A3";  // Aquí debes poner el nombre de tu red
const char* password = "AIN041006768";  // Aquí debes poner la contraseña de tu red

//Datos del broker MQTT
const char* mqtt_server = "192.168.10.174"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
IPAddress server(192,168,10,174);
